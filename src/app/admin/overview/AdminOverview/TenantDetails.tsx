...
interface TenantDetailsProps {
  tenant: any;
  landlord?: any | null; // <- ADD THIS LINE
  onClose: () => void;
}
...
const TenantDetails: React.FC<TenantDetailsProps> = ({ tenant, onClose }) => {
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-10 text-sm">
            {[
              ...
              { label: "Phone number", value: tenant.phoneNumber },
              { label: "Email", value: tenant.email },
              {
                label: "Occupancy date",
                value: formatDate(tenant.occupancyDate),
              },
              { label: "Renewal date", value: formatDate(tenant.renewalDate) },
              { label: "Selected property", value: tenant.propertyName },
